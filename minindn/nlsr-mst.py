...
def mstFailure(ndn, nfds, nlsrs, args):
    mysleep(args.ctime)
    ...
    if args.fw_strategy == 'asf':
        ...
        fw_strategy = 'asf/%FD%03/probing-interval~1000'
...
if __name__ == '__main__':
    ...
    myinfo('Starting nlsr\n')
    nlsrs = AppManager(ndn, ndn.net.hosts, Nlsr, nFaces=4, logLevel='ndn.*=DEBUG:nlsr.*=DEBUG') 

    myinfo('Starting mstFailure()\n')
    mstFailure(ndn, nfds, nlsrs, args)
